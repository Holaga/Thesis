\chapter{Background}
    In this chapter, the key concepts used during the experiments will be introduced.
...
\section{Acoustic Surveys}
    ...
    \cite{simmonds2008fisheries}
\subsection{Acoustic data}


\subsection{Acoustic Data and Image Data} \label{echosounder and image data acoustic }
