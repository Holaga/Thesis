...
\section{Result exhaustive search}
    ...
    \subsection{Training}
        ...
        \begin{figure}[H]
            ...
            \qquad
            \subfloat[\centering F1-score]{{\includegraphics[width=5cm]{figures/F1_score_per_5.png} }}%
    ...
    \subsection{All combinations}
        ...
        \begin{figure}[H]
            ...
            \includesvg[inkscapelatex=false,width=0.9\textwidth,keepaspectratio]{figures/error_bars.svg}
