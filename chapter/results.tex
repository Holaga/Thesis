...
\section{Experiment: Exhaustive Search}
    ...
    \subsection{Training}
        ...
        \begin{figure}[H]
            \centering
            \subfloat[\centering Loss is visualized along the y-axis, and the x-axis represents epochs.]{{\includegraphics[width=5cm]{figures/Loss_val_train.png} }}%
            \qquad
            \subfloat[\centering F1-score is visualized along the y-axis, and the x-axis represents epochs.]{{\includegraphics[width=5cm]{figures/F1_score_per_5.png} }}%
