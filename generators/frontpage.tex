...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Selecting Maximally Informative Frequency Subsets for Acoustic Surveys}\\[0.7cm] % Title of your document
\end{Huge}

%First: Analysis of frequencies used in acoustic classification of sandeel through deep learning
...
{\large June, 2022}\\[3cm] % Date, change the \today to a set date if you want to be precise
